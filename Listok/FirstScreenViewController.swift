...
class FirstScreenViewController: UIViewController {
    ...
    lazy var mainIconImage = createMainIconImage()
    lazy var iconImage = createIconImage()
    lazy var descriptionLabel = createDescriptionLabel()
    lazy var buttonSignUp = createButtonSignUp()
    lazy var buttonLogin = createButtonLogin()
